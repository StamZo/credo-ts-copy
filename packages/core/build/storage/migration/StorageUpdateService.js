...
let StorageUpdateService = class StorageUpdateService {
    ...
    async setCurrentStorageVersion(agentContext, storageVersion) {
        ...
        const storageVersionRecord = await this.storageVersionRepository.findById(agentContext, StorageVersionRecord_1.StorageVersionRecord.storageVersionRecordId);
    ...
    async getStorageVersionRecord(agentContext) {
        let storageVersionRecord = await this.storageVersionRepository.findById(agentContext, StorageVersionRecord_1.StorageVersionRecord.storageVersionRecordId);
        if (!storageVersionRecord) {
...
exports.StorageUpdateService = StorageUpdateService = __decorate([
