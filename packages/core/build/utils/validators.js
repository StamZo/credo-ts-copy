...
function IsInstanceOrArrayOfInstances(validationOptions) {
    ...
    return (0, class_validator_1.ValidateBy)({
        ...
        validator: {
            ...
            defaultMessage: (0, class_validator_1.buildMessage)((eachPrefix) => `${eachPrefix}$property value must be an instance of, or an array of instances containing ${classTypes
                .map((c) => c.name)
