...
export type { InitConfig, JsonArray, JsonObject, JsonValue, ResolvedDidCommService, XOR, CanBePromise, SingleOrArray, Optional, } from './types';
...
export { JsonEncoder, JsonTransformer, TypedArrayEncoder, HashlinkEncoder, BaseName, Buffer, deepEquality, isDid, IsUri, IsStringOrInstance, asArray, equalsIgnoreOrder, equalsWithOrder, DateTransformer, } from './utils';
export * from './logger';
export * from './error';
export type { Constructor, Constructable } from './utils/mixins';
export * from './agent/Events';
export * from './crypto';
export { didKeyToEd25519PublicJwk, didKeyToVerkey, verkeyToDidKey, verkeyToPublicJwk, isDidKey, } from './modules/dids/helpers';
...
declare const utils: {
    ...
    getProtocolScheme: typeof getProtocolScheme;
    timestamp: typeof timestamp;
    indyDidFromPublicKeyBase58: typeof indyDidFromPublicKeyBase58;
};
export { utils };
