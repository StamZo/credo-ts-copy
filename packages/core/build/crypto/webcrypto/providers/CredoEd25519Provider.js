...
class CredoEd25519Provider extends core.Ed25519Provider {
    ...
    async onGenerateKey(algorithm, extractable, keyUsages) {
        ...
        const publicJwk = kms_1.PublicJwk.fromPublicJwk(key.publicJwk);
        return {
            publicKey: new CredoWebCryptoKey_1.CredoWebCryptoKey(publicJwk, algorithm, extractable, 'public', keyUsages),
            privateKey: new CredoWebCryptoKey_1.CredoWebCryptoKey(publicJwk, algorithm, extractable, 'private', keyUsages),
        };
    }
