...
let W3cCredentialService = class W3cCredentialService {
    ...
    async signCredential(agentContext, options) {
        ...
        if (options.format === models_1.ClaimFormat.LdpVc) {
    ...
    async verifyCredential(agentContext, options) {
        ...
        if (options.credential instanceof jwt_vc_1.W3cJwtVerifiableCredential || typeof options.credential === 'string') {
    ...
    async signPresentation(agentContext, options) {
        ...
        if (options.format === models_1.ClaimFormat.LdpVp) {
    ...
    async verifyPresentation(agentContext, options) {
        ...
        if (options.presentation instanceof jwt_vc_1.W3cJwtVerifiablePresentation || typeof options.presentation === 'string') {
