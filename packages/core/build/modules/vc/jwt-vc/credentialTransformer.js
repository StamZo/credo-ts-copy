...
function getCredentialFromJwtPayload(jwtPayload) {
    if (!('vc' in jwtPayload.additionalClaims) || !(0, types_1.isJsonObject)(jwtPayload.additionalClaims.vc)) {
    ...
    if (!(0, types_1.isJsonObject)(credentialSubject)) {
    ...
    if ((typeof jwtVc.issuer === 'string' && jwtPayload.iss !== jwtVc.issuer) ||
        ((0, types_1.isJsonObject)(jwtVc.issuer) && jwtVc.issuer.id && jwtPayload.iss !== jwtVc.issuer.id)) {
