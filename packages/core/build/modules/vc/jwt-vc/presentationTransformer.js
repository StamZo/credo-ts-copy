...
function getPresentationFromJwtPayload(jwtPayload) {
    if (!('vp' in jwtPayload.additionalClaims) || !(0, types_1.isJsonObject)(jwtPayload.additionalClaims.vp)) {
    ...
    if ((typeof jwtVp.holder === 'string' && jwtPayload.iss !== jwtVp.holder) ||
        ((0, types_1.isJsonObject)(jwtVp.holder) && jwtVp.holder.id && jwtPayload.iss !== jwtVp.holder.id)) {
