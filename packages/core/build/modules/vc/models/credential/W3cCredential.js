    ...
    constructor(options) {
        if (options) {
            ...
            if (options.credentialSchema) {
                this.credentialSchema = (0, utils_1.mapSingleOrArray)(options.credentialSchema, (schema) => schema instanceof W3cCredentialSchema_1.W3cCredentialSchema ? schema : new W3cCredentialSchema_1.W3cCredentialSchema(schema));
            }
        }
    }
    get issuerId() {
