...
const KmsKeyPair_1 = require("../../../crypto/KmsKeyPair");
...
let W3cJsonLdCredentialService = class W3cJsonLdCredentialService {
    ...
    async signCredential(agentContext, options) {
        const WalletKeyPair = (0, KmsKeyPair_1.createKmsKeyPairClass)(agentContext);
        ...
        try {
            ...
            throw new error_1.CredoError(`Error issuing W3C JSON-LD VC. ${error.message}`, {
                cause: error,
            });
        }
    }
    ...
    async getPublicJwkFromVerificationMethod(agentContext, verificationMethod) {
        ...
        const verificationMethodInstance = utils_1.JsonTransformer.fromJSON(verificationMethodObject.document, dids_1.VerificationMethod);
        const did = (0, dids_1.parseDid)(verificationMethod);
        const publicJwk = (0, key_type_1.getPublicJwkFromVerificationMethod)(verificationMethodInstance);
