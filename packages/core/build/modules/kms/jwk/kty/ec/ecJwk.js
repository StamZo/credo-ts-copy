...
exports.zKmsJwkPrivateEc = exports.zKmsJwkPrivateToPublicEc = exports.zKmsJwkPublicEc = void 0;
const z = __importStar(require("../../../../../utils/zod"));
const jwk_1 = require("../../jwk");
exports.zKmsJwkPublicEc = z.object({
...
exports.zKmsJwkPrivateToPublicEc = z.object({
    ...exports.zKmsJwkPublicEc.shape,
    d: z.optionalToUndefined(z.base64Url),
});
exports.zKmsJwkPrivateEc = z.object({
    ...exports.zKmsJwkPublicEc.shape,
    // Private
    d: z.base64Url,
});
//# sourceMappingURL=ecJwk.js.map