...
export declare class P521PublicJwk implements PublicJwkType<Jwk> {
    readonly jwk: Jwk;
    ...
    static fromPublicKey(publicKey: Uint8Array): P521PublicJwk;
    static fromMulticodec(multicodec: Uint8Array): P521PublicJwk;
}
export {};
