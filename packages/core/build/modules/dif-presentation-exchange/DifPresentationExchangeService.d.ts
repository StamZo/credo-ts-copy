...
export declare class DifPresentationExchangeService {
    ...
    createPresentation(agentContext: AgentContext, options: {
        ...
        verifiablePresentations: (import("../vc").W3cJwtVerifiablePresentation | import("../vc").W3cJsonLdVerifiablePresentation | import("../sd-jwt-vc").SdJwtVc<import("../sd-jwt-vc").SdJwtVcHeader, import("../sd-jwt-vc").SdJwtVcPayload> | MdocDeviceResponse)[];
