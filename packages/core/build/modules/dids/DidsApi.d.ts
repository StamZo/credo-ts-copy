...
export declare class DidsApi {
    ...
    constructor(didResolverService: DidResolverService, didRegistrarService: DidRegistrarService, didRepository: DidRepository, agentContext: AgentContext, config: DidsModuleConfig, _keyManagement: KeyManagementApi);
    /**
     ...
     */
    import({ did, didDocument, keys, overwrite }: ImportDidOptions): Promise<void>;
    resolveCreatedDidDocumentWithKeys(did: string): Promise<{
        keys: import("./DidsApiOptions").DidDocumentKey[] | undefined;
        didDocument: import("./domain").DidDocument;
    }>;
    resolveVerificationMethodFromCreatedDidRecord(didUrl: string, allowedPurposes?: Array<DidPurpose | 'verificationMethod'>): Promise<{
        verificationMethod: import("./domain").VerificationMethod;
        publicJwk: import("../kms").PublicJwk<import("../kms/jwk/PublicJwk").SupportedPublicJwk>;
    }>;
