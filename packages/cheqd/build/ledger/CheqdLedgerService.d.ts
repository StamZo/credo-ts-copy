import type { CheqdSDK, DIDDocument, DidStdFee } from '@cheqd/sdk';
import type { QueryAllDidDocVersionsMetadataResponse, SignInfo } from '@cheqd/ts-proto/cheqd/did/v2';
import type { Metadata, MsgCreateResourcePayload, QueryCollectionResourcesResponse, ResourceWithMetadata } from '@cheqd/ts-proto/cheqd/resource/v2';
