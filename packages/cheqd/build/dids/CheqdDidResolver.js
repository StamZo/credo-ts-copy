...
class CheqdDidResolver {
    ...
    async resolveResource(agentContext, did) {
        ...
        try {
            ...
            let resourceId;
            if (did.match(identifiers_1.cheqdResourceRegex)?.input) {
