    ...
    async registerSchema(agentContext, options) {
        ...
        try {
            ...
            if (endorsedTransaction) {
                ...
                const submitterKey = await (0, didIndyUtil_1.verificationPublicJwkForIndyDid)(agentContext, issuerId);
                ...
                if (endorserMode === 'internal' && endorserDid !== issuerId) {
                    const endorserKey = await (0, didIndyUtil_1.verificationPublicJwkForIndyDid)(agentContext, endorserDid);
    ...
    async registerRevocationRegistryDefinition(agentContext, { options, revocationRegistryDefinition }) {
        try {
            ...
            if (endorsedTransaction) {
                ...
                const submitterKey = await (0, didIndyUtil_1.verificationPublicJwkForIndyDid)(agentContext, revocationRegistryDefinition.issuerId);
    ...
    async registerRevocationStatusList(agentContext, { options, revocationStatusList }) {
        try {
            ...
            if (endorsedTransaction) {
                ...
                const revocationRegistryDefinitionEntryValue = (0, transform_1.indyVdrCreateLatestRevocationDelta)(revocationStatusList.currentAccumulator, revocationStatusList.revocationList, previousDelta ?? undefined);
                ...
                const submitterKey = await (0, didIndyUtil_1.verificationPublicJwkForIndyDid)(agentContext, revocationStatusList.issuerId);
