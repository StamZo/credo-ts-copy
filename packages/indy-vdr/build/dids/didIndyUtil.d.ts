...
import { DidDocument, DidDocumentBuilder, Kms } from '@credo-ts/core';
...
export declare function indyDidFromNamespaceAndInitialKey(namespace: string, initialKey: Kms.PublicJwk<Kms.Ed25519PublicJwk>): {
    did: string;
    id: string;
    verkey: string;
};
 ...
 */
export declare function verificationPublicJwkForIndyDid(agentContext: AgentContext, did: string): Promise<Kms.PublicJwk<Kms.Ed25519PublicJwk>>;
