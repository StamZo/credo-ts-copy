...
class Feature {
    ...
    combine(feature) {
        if (feature.id !== this.id) {
            throw new core_1.CredoError('Can only combine with a feature with the same id');
        }
        const obj1 = core_1.JsonTransformer.toJSON(this);
        const obj2 = core_1.JsonTransformer.toJSON(feature);
        ...
        return core_1.JsonTransformer.fromJSON(obj1, Feature);
    }
    toJSON() {
