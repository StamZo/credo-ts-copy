...
const didCommMessageRoleMapping = {
    [V02_03MigrationProofRole.Verifier]: {
        ...
        presentationMessage: repository_1.DidCommMessageRole.Receiver,
    },
    [V02_03MigrationProofRole.Prover]: {
        ...
        presentationMessage: repository_1.DidCommMessageRole.Sender,
    },
};
...
function getProofRole(proofRecord) {
    ...
    if (proofRecord.state === proofs_1.ProofState.Done) {
