...
class DidDoc {
    constructor(options) {
        this.context = core_1.DID_V1_CONTEXT_URL;
        this.publicKey = [];
        this.service = [];
        this.authentication = [];
        if (options) {
     ...
     */
    get didCommServices() {
        const didCommServiceTypes = [core_1.IndyAgentService.type, core_1.DidCommV1Service.type];
...
__decorate([
    ...
    (0, class_validator_1.Equals)('https://www.w3.org/ns/did/v1'),
