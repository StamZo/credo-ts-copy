...
class ConnectionResponseHandler {
    ...
    async handle(messageContext) {
        ...
        if (!recipientKey || !senderKey) {
            throw new core_1.CredoError('Unable to process connection response without senderKey or recipientKey');
        }
        ...
        if (!outOfBandRecord) {
            throw new core_1.CredoError(`Out-of-band record ${connectionRecord.outOfBandId} was not found.`);
        }
