...
import { DidRepository, JwsService, Logger } from '@credo-ts/core';
...
export declare class DidExchangeProtocol {
    ...
    private logger;
    constructor(connectionService: ConnectionService, didRepository: DidRepository, jwsService: JwsService, didcommDocumentService: DidCommDocumentService, logger: Logger);
