...
export type ConnectionInvitationMessageOptions = BaseInvitationOptions & (DIDInvitationOptions | InlineInvitationOptions);
/**
...
export declare class ConnectionInvitationMessage extends AgentMessage {
     ...
     * @param options
     */
    constructor(options: ConnectionInvitationMessageOptions);
