...
const thread_1 = require("../../../util/thread");
const messages_1 = require("../messages");
class OutOfBandRecord extends core_1.BaseRecord {
    constructor(props) {
        super();
    ...
    assertRole(expectedRole) {
        if (this.role !== expectedRole) {
            throw new core_1.CredoError(`Invalid out-of-band record role ${this.role}, expected is ${expectedRole}.`);
        }
    }
    assertState(expectedStates) {
        ...
        if (!expectedStates.includes(this.state)) {
            throw new core_1.CredoError(`Invalid out-of-band record state ${this.state}, valid states are: ${expectedStates.join(', ')}.`);
        }
    }
}
