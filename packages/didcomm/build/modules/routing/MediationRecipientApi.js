...
let MediationRecipientApi = class MediationRecipientApi {
    ...
    async initiateImplicitMode(mediator) {
        ...
        if (!hasWebSocketTransport) {
            throw new core_1.CredoError('Cannot open websocket to connection without websocket service endpoint');
        }
    ...
    async initiateMessagePickup(mediator, pickupStrategy) {
        ...
        if (!mediatorRecord) {
            throw new core_1.CredoError('There is no mediator to pickup messages from');
        }
    ...
    async notifyKeylistUpdate(connection, verkey, action) {
        ...
        const message = this.mediationRecipientService.createKeylistUpdateMessage([
            new messages_1.KeylistUpdate({
                ...
                recipientKey: useDidKey ? (0, core_1.verkeyToDidKey)(verkey) : verkey,
            }),
        ]);
    ...
    async requestAndAwaitGrant(connection, timeoutMs = 10000) {
        ...
        observable
            .pipe((0, core_1.filterContextCorrelationId)(this.agentContext.contextCorrelationId), 
...
exports.MediationRecipientApi = MediationRecipientApi = __decorate([
    (0, core_1.injectable)(),
    __param(10, (0, core_1.inject)(core_1.InjectionSymbols.Logger)),
    __param(12, (0, core_1.inject)(core_1.InjectionSymbols.Stop$)),
    __metadata("design:paramtypes", [MessageHandlerRegistry_1.MessageHandlerRegistry,
        ...
        RoutingService_1.RoutingService, Object, core_1.AgentContext,
        rxjs_1.Subject,
