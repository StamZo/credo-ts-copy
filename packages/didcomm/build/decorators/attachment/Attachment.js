...
class Attachment {
    constructor(options) {
        if (options) {
            this.id = options.id ?? core_1.utils.uuid();
    ...
    getDataAsJson() {
        if (typeof this.data.base64 === 'string') {
            return core_1.JsonEncoder.fromBase64(this.data.base64);
        }
        if (this.data.json) {
            return this.data.json;
        }
        throw new core_1.CredoError('No attachment data found in `json` or `base64` data fields.');
    }
    addJws(jws) {
