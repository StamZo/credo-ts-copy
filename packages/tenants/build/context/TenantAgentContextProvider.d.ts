import { AgentContextProvider, UpdateAssistantUpdateOptions } from '@credo-ts/core';
...
export declare class TenantAgentContextProvider implements AgentContextProvider {
    ...
    getAgentContextForContextCorrelationId(contextCorrelationId: string, { provisionContext }?: {
