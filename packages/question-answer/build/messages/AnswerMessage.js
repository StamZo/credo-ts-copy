...
class AnswerMessage extends didcomm_1.AgentMessage {
    /**
...
AnswerMessage.type = (0, didcomm_1.parseMessageType)('https://didcomm.org/questionanswer/1.0/answer');
__decorate([
    (0, didcomm_1.IsValidMessageType)(AnswerMessage.type),
