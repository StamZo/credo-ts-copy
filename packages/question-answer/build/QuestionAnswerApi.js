...
let QuestionAnswerApi = class QuestionAnswerApi {
    constructor(questionAnswerService, messageSender, connectionService, agentContext) {
        ...
        this.agentContext.dependencyManager
            .resolve(didcomm_1.MessageHandlerRegistry)
    ...
    async sendQuestion(connectionId, config) {
        ...
        const outboundMessageContext = await (0, didcomm_1.getOutboundMessageContext)(this.agentContext, {
...
exports.QuestionAnswerApi = QuestionAnswerApi = __decorate([
    (0, core_1.injectable)(),
    __metadata("design:paramtypes", [services_1.QuestionAnswerService,
        didcomm_1.MessageSender,
        didcomm_1.ConnectionService,
        core_1.AgentContext])
], QuestionAnswerApi);
