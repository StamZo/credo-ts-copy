...
import { IndyBesuModuleConfig, IndyBesuModuleConfigOptions,IndyBesuModuleConfigToken } from './IndyBesuModuleConfig'
...
export class IndyBesuModule implements Module {
  ...
  public register(dependencyManager: DependencyManager) {
    dependencyManager.registerInstance(IndyBesuModuleConfigToken, this.config)
