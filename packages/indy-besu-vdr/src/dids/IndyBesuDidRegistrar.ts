...
import { IndyBesuModuleConfig,IndyBesuModuleConfigToken} from '../IndyBesuModuleConfig'
import 'reflect-metadata'
...
export class IndyBesuDidRegistrar implements DidRegistrar {
 ...
 try {
    ...
    const config = agentContext.dependencyManager.resolve(IndyBesuModuleConfigToken) as IndyBesuModuleConfig
