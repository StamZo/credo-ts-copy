import 'reflect-metadata' // Keep if other files rely on it, but not strictly needed here

export const IndyBesuModuleConfigToken = Symbol('IndyBesuModuleConfigToken');
