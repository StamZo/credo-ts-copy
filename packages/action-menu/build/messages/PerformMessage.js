 ...
 * @internal
 */
class PerformMessage extends didcomm_1.AgentMessage {
    constructor(options) {
        super();
...
PerformMessage.type = (0, didcomm_1.parseMessageType)('https://didcomm.org/action-menu/1.0/perform');
__decorate([
    (0, didcomm_1.IsValidMessageType)(PerformMessage.type),
