 ...
 * @internal
 */
class MenuMessage extends didcomm_1.AgentMessage {
    constructor(options) {
        super();
...
MenuMessage.type = (0, didcomm_1.parseMessageType)('https://didcomm.org/action-menu/1.0/menu');
__decorate([
    (0, didcomm_1.IsValidMessageType)(MenuMessage.type),
