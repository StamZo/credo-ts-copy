...
class DrpcRequestMessage extends didcomm_1.AgentMessage {
    constructor(options) {
        super();
...
DrpcRequestMessage.type = (0, didcomm_1.parseMessageType)('https://didcomm.org/drpc/1.0/request');
__decorate([
    (0, didcomm_1.IsValidMessageType)(DrpcRequestMessage.type),
