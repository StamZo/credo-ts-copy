...
class DrpcResponseMessage extends didcomm_1.AgentMessage {
    constructor(options) {
        super();
...
DrpcResponseMessage.type = (0, didcomm_1.parseMessageType)('https://didcomm.org/drpc/1.0/response');
__decorate([
    (0, didcomm_1.IsValidMessageType)(DrpcResponseMessage.type),
