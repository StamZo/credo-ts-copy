    ...
    async start(agentContext) {
        ...
        this.app.post(this.path, async (req, res) => {
            ...
            try {
                ...
                const observable = eventEmitter.observable(didcomm_1.AgentEventTypes.AgentMessageProcessed);
                const subject = new rxjs_1.ReplaySubject(1);
                observable
                    .pipe((0, rxjs_1.filter)((e) => e.type === didcomm_1.AgentEventTypes.AgentMessageProcessed), (0, rxjs_1.filter)((e) => e.payload.encryptedMessage === encryptedMessage), (0, rxjs_1.timeout)({
