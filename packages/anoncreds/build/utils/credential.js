...
const bytesToBigint_1 = require("./bytesToBigint");
...
function encodeCredentialValue(value) {
    ...
    return (0, bytesToBigint_1.bytesToBigint)(hash).toString();
}
...
function createAndLinkAttachmentsToPreview(attachments, previewAttributes) {
    ...
    for (const linkedAttachment of attachments) {
        ...
        newPreviewAttributes.push({
            ...
            value: (0, didcomm_1.encodeAttachment)(linkedAttachment.attachment),
        });
    }
