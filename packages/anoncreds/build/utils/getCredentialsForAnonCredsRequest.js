...
const getRevocationStatus = async (agentContext, proofRequest, requestedItem, credentialInfo) => {
    ...
    const { revocationStatusList } = await (0, anonCredsObjects_1.fetchRevocationStatusList)(agentContext, revocationRegistryId, requestNonRevoked.to ?? (0, timestamp_1.dateToTimestamp)(new Date()));
