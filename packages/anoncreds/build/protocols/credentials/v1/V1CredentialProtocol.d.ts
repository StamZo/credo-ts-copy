...
import type { AgentMessage, CredentialProtocol, CredentialProtocolOptions, ExtractCredentialFormats, FeatureRegistry, InboundMessageContext, MessageHandlerRegistry, ProblemReportMessage } from '@credo-ts/didcomm';
import type { LegacyIndyCredentialFormatService } from '../../../formats';
import { BaseCredentialProtocol, CredentialExchangeRecord } from '@credo-ts/didcomm';
