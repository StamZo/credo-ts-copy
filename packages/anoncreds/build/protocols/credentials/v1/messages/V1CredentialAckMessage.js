 ...
 */
class V1CredentialAckMessage extends didcomm_1.AckMessage {
    constructor() {
        super(...arguments);
...
V1CredentialAckMessage.type = (0, didcomm_1.parseMessageType)('https://didcomm.org/issue-credential/1.0/ack');
__decorate([
    (0, didcomm_1.IsValidMessageType)(V1CredentialAckMessage.type),
