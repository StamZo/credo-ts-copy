...
class V1CredentialPreview {
    constructor(options) {
        ...
        if (options) {
            this.attributes = options.attributes.map((a) => new didcomm_1.CredentialPreviewAttribute(a));
        }
    }
    toJSON() {
    ...
    static fromRecord(record) {
        const attributes = Object.entries(record).map(([name, value]) => new didcomm_1.CredentialPreviewAttribute({
            name,
            mimeType: 'text/plain',
            value,
        }));
...
V1CredentialPreview.type = (0, didcomm_1.parseMessageType)('https://didcomm.org/issue-credential/1.0/credential-preview');
__decorate([
    (0, class_transformer_1.Expose)({ name: '@type' }),
    (0, didcomm_1.IsValidMessageType)(V1CredentialPreview.type),
    (0, class_transformer_1.Transform)(({ value }) => (0, didcomm_1.replaceLegacyDidSovPrefix)(value), {
        toClassOnly: true,
    }),
    __metadata("design:type", Object)
], V1CredentialPreview.prototype, "type", void 0);
__decorate([
    (0, class_transformer_1.Type)(() => didcomm_1.CredentialPreviewAttribute),
    (0, class_validator_1.ValidateNested)({ each: true }),
    (0, class_validator_1.IsInstance)(didcomm_1.CredentialPreviewAttribute, { each: true }),
