...
class V1PresentationAckMessage extends didcomm_1.AckMessage {
    constructor() {
        super(...arguments);
...
V1PresentationAckMessage.type = (0, didcomm_1.parseMessageType)('https://didcomm.org/present-proof/1.0/ack');
__decorate([
    (0, didcomm_1.IsValidMessageType)(V1PresentationAckMessage.type),
