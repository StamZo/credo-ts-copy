 ...
 */
class V1ProposePresentationMessage extends didcomm_1.AgentMessage {
    constructor(options) {
        super();
...
V1ProposePresentationMessage.type = (0, didcomm_1.parseMessageType)('https://didcomm.org/present-proof/1.0/propose-presentation');
__decorate([
    (0, didcomm_1.IsValidMessageType)(V1ProposePresentationMessage.type),
