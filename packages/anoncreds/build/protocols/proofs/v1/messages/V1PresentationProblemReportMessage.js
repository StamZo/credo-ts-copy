 ...
 */
class V1PresentationProblemReportMessage extends didcomm_1.ProblemReportMessage {
    constructor() {
        super(...arguments);
...
V1PresentationProblemReportMessage.type = (0, didcomm_1.parseMessageType)('https://didcomm.org/present-proof/1.0/problem-report');
__decorate([
    (0, didcomm_1.IsValidMessageType)(V1PresentationProblemReportMessage.type),
