 ...
 */
class V1PresentationMessage extends didcomm_1.AgentMessage {
    constructor(options) {
        super();
    ...
    get indyProof() {
        const attachment = this.presentationAttachments.find((attachment) => attachment.id === exports.INDY_PROOF_ATTACHMENT_ID) ?? null;
        const proofJson = attachment?.getDataAsJson() ?? null;
        return proofJson;
    }
...
V1PresentationMessage.type = (0, didcomm_1.parseMessageType)('https://didcomm.org/present-proof/1.0/presentation');
__decorate([
    (0, didcomm_1.IsValidMessageType)(V1PresentationMessage.type),
