...
import type { AgentMessage, FeatureRegistry, GetProofFormatDataReturn, InboundMessageContext, MessageHandlerRegistry, ProblemReportMessage, ProofFormat, ProofProtocol, ProofProtocolOptions } from '@credo-ts/didcomm';
