...
export declare class V1RequestPresentationHandler implements MessageHandler {
    ...
    handle(messageContext: MessageHandlerInboundMessage<V1RequestPresentationHandler>): Promise<import("@credo-ts/didcomm").OutboundMessageContext<import("@credo-ts/didcomm").AgentMessage> | undefined>;
