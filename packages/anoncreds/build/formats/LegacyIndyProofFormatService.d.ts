...
import type { FormatCreateRequestOptions, ProofFormatAcceptProposalOptions, ProofFormatAcceptRequestOptions, ProofFormatAutoRespondPresentationOptions, ProofFormatAutoRespondProposalOptions, ProofFormatAutoRespondRequestOptions, ProofFormatCreateProposalOptions, ProofFormatCreateReturn, ProofFormatGetCredentialsForRequestOptions, ProofFormatGetCredentialsForRequestReturn, ProofFormatProcessOptions, ProofFormatProcessPresentationOptions, ProofFormatSelectCredentialsForRequestOptions, ProofFormatSelectCredentialsForRequestReturn, ProofFormatService } from '@credo-ts/didcomm';
...
export declare class LegacyIndyProofFormatService implements ProofFormatService<LegacyIndyProofFormat> {
    ...
    processProposal(_agentContext: AgentContext, { attachment }: ProofFormatProcessOptions): Promise<void>;
    ...
    processRequest(_agentContext: AgentContext, { attachment }: ProofFormatProcessOptions): Promise<void>;
    ...
    shouldAutoRespondToRequest(_agentContext: AgentContext, { proposalAttachment, requestAttachment }: ProofFormatAutoRespondRequestOptions): Promise<boolean>;
