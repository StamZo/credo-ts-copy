...
import type { AnonCredsCredential, AnonCredsCredentialDefinition, AnonCredsCredentialInfo, AnonCredsProof, AnonCredsRevocationRegistryDefinition, AnonCredsSchema } from '../models';
import type { AnonCredsHolderService, CreateCredentialRequestOptions, CreateCredentialRequestReturn, CreateLinkSecretOptions, CreateLinkSecretReturn, CreateProofOptions, GetCredentialOptions, GetCredentialsForProofRequestOptions, GetCredentialsForProofRequestReturn, GetCredentialsOptions, StoreCredentialOptions } from '../services';
...
export declare class AnonCredsRsHolderService implements AnonCredsHolderService {
    createLinkSecret(_agentContext: AgentContext, options?: CreateLinkSecretOptions): Promise<CreateLinkSecretReturn>;
    /**
    ...
    w3cToLegacyCredential(_agentContext: AgentContext, options: W3cToLegacyCredentialOptions): Promise<AnonCredsCredential>;
