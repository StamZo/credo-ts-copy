...
import type { OpenId4VcCredentialHolderBinding, OpenId4VciAccessTokenResponse, OpenId4VciCredentialConfigurationSupportedWithFormats, OpenId4VciCredentialConfigurationsSupportedWithFormats, OpenId4VciMetadata } from '../shared';
...
export type OpenId4VciProofOfPressionProofTypes = Record<'jwt' | 'attestation', {
    /**
